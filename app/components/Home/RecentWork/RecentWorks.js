      ...
      <div className="mx-5 lg:container lg:mx-auto lg:max-w-[1200px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-5">
          <div className="relative ">
            <Image src={img1} className="" alt="Shoes" layout="responsive" />
          ...
          <div className="relative ">
            <Image src={img1} className="" alt="Shoes" layout="responsive" />
            <div className="absolute inset-0 bg-black opacity-50"></div>
            <div className="absolute bottom-0 p-5 border-b-4 border-green-500 w-full hover:bg-green-500 duration-1000 hover:bg-opacity-50">
              <h2 className="text-2xl font-serif text-white font-bold">
                PSO Banglow, Dhaka Dantonment.
              </h2>
              <div className="flex gap-2 mt-2">
