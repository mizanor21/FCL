      ...
      <div className="lg:container lg:max-w-[1200px] lg:mx-auto mx-5 py-20">
        ...
        <div className="text-justify">
          ...
          <p>
            ...
            voluptates rem at neque quos facere sequi unde optio aliquam! Lorem
          ...
          <p>
            ...
            at! Lorem ipsum dolor sit amet, consectetur adipisicing elit. Qui
        ...
        <h1 className="text-3xl font-serif mb-10 mt-10">Vission</h1>
        <div className="text-justify">
          <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Qui dicta
            minus molestiae vel beatae natus eveniet ratione temporibus aperiam
        ...
        <h1 className="text-3xl font-serif mb-10 mt-10">MIssion</h1>
        <div className="text-justify">
          <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Qui dicta
            minus molestiae vel beatae natus eveniet ratione temporibus aperiam
        ...
        <h1 className="text-3xl font-serif mb-10 mt-10">
        ...
        <div className="text-justify ">
          ...
          <p className="mb-3 font-bold">
            The major objectives , as have been identified, are:
          </p>
          <ul>
            <li className="mb-7">
              <p>
                ...
                quibusdam deleniti eos cupiditate dolore doloribus! Lorem ipsum
